    ...
    function getVariables()
    {
        $variables = array (
            /*T*/'Plugin Name'/*/T*/ => array (
                                ...
                                'value'         =>/*T*/'Quantum Gateway'/*/T*/
                               ),
            /*T*/'Use Verify By Visa and MasterCard SecureCode'/*/T*/ => array(
                                'type'          =>'yesno',
                                'description'   =>/*T*/'Be sure to have these services enabled in your gateway before attempting to use them.'/*/T*/,
                                'value'         =>0,
                               ),
            /*T*/'Use DialVerify Service'/*/T*/ => array(
                                'type'          =>'yesno',
                                'description'   =>/*T*/'Be sure to have this service enabled in your gateway before attempting to use it.'/*/T*/,
                                'value'         =>0,
                               ),
            /*T*/'Use Maxmind'/*/T*/ => array(
                                'type'          =>'yesno',
                                'description'   =>/*T*/'Use Quantum Gateway\'s Maxmind fraud screening services.'/*/T*/,
                                'value'         =>0,
                               ),
            /*T*/'Quantum Gateway Username'/*/T*/ => array (
                                'type'          =>'text',
                                'description'   =>/*T*/'Please enter your Quantum Gateway Username Here.'/*/T*/,
                                'value'         =>''
                               ),
            /*T*/'Quantum Gateway RestrictKey'/*/T*/ => array (
                                'type'          =>'password',
                                'description'   =>/*T*/'Please enter your Quantum Gateway RestrictKey Here.'/*/T*/,
                                'value'         =>''
                               ),
